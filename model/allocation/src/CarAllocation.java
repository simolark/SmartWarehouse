...
public class CarAllocation {
    ...
    public static void allocate(int cargo, double distance, Car[] cars) throws InterruptedException {
        ...
        //小车数量不够
            ...
            //等待再次有空闲的小车并分配
            pause(cars);
            CarAllocation.allocate(cargo, distance, cars);
            System.out.println("");
        }
    ...
    //将小车状态置为空闲
    private static void reset(Car car, long time){
    ...
    //等待有空闲的小车
    private static void pause(Car[] cars) throws InterruptedException {
    ...
    //判断是否有小车空闲
    private static boolean isFree(Car[] cars){
