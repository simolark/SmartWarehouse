...
public class JwtUtil {
    ...
    private static final String defaultbase64EncodedSecretKey
            = "cuAihCz53DZRjZwbsGcZJ2Ai6At+T142uphtJMsk7iQ=";

    private static final SignatureAlgorithm defaultsignatureAlgorithm = SignatureAlgorithm.HS256;

    private static final SecretKey key = Keys.hmacShaKeyFor(defaultbase64EncodedSecretKey.getBytes());;
    ...
    public String encode(String iss, long ttlMillis, Map<String, Object> claims) {
        ...
        JwtBuilder builder = Jwts.builder()
                ...
                .signWith(key);//这个地方是生成jwt使用的算法和秘钥
        if (ttlMillis >= 0) {
...
//        String key256 = new String(key.getEncoded());
